# Offline Crypto Trading

## Problem

Sequential trading over replayed historical hourly bars for crypto pairs. The broker holds the data and replays it one bar at a time, so no look-ahead is possible.
